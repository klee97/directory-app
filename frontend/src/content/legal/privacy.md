...
When you create an account, submit vendor inquiries, or use our Services, we collect:

- **User Account Information:** Name, email address, password, profile information, and preferences.

- **Vendor Inquiry Information:** When you submit an inquiry to a vendor through our platform, we collect your name, email address, wedding date, location, budget range, service preferences (such as makeup style preferences), and any message or details you provide about your wedding needs.
...
We use your personal information to provide you with the Services, including to create, maintain and otherwise manage your account, save your vendor favorites, enable you to use the directory features, and **facilitate your vendor inquiries by transmitting your inquiry information to the vendors you choose to contact**.

### Vendor Matching and Inquiry Transmission

**When you submit an inquiry through our platform, we share your inquiry information (including your name, email, wedding details, service preferences, budget, and message) with the specific vendor(s) you select.** This allows vendors to respond to your inquiry directly.

### Improving Our Services

We analyze user behavior and preferences to enhance user experience, improve vendor recommendations, troubleshoot technical issues, and develop new features for the directory.
...
We use your personal information to provide you with customer support, respond to your questions, and improve our Services. This is in our legitimate interests in order to be responsive to you, to provide effective services to you, and to maintain our business relationship with you.
...
### Sharing with Vendors You Contact

**When you submit an inquiry to a vendor through our platform, we share your inquiry information with that specific vendor so they can respond to your request.** This includes your name, email address, wedding details, service preferences, budget information, and any message you include. *This sharing is essential to the core function of our directory service.*
...
We may disclose your information in connection with a business transaction such as a merger, acquisition, or bankruptcy, to comply with any applicable legal obligations (including to respond to subpoenas, search warrants and similar requests), to enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.
...
- **Managing Communication Preferences:** We may send you promotional emails, and you may opt out of receiving these at any time by using the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or inquiries that you have submitted.
